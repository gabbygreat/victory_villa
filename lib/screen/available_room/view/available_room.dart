...
import 'package:victory_villa/screen/available_room/controller/available_room_controller.dart';
...
class AvailableRoom extends ConsumerWidget {
  const AvailableRoom({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    AsyncValue<List<RoomInfo>?> state = ref.watch(availableRoomProvider);
    return WillPopScope(
      onWillPop: onWillPop,
      child: Scaffold(
            ...
            Padding(
              ...
              child: SizedBox(
                child: RoomDetailSelector(
                  searchText: true,
                  perform: () {
                    ref.refresh(availableRoomProvider);
                  },
                ),
              ),
            ),
