...
import 'package:victory_villa/screen/unavailable_room/controller/unavailable_room_controller.dart';
...
class UnavailableRoom extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    AsyncValue<List<RoomInfo>?> state = ref.watch(unavailableRoomProvider);
    return WillPopScope(
      onWillPop: onWillPop,
      child: Scaffold(
            ...
            Padding(
              ...
              child: SizedBox(
                child: RoomDetailSelector(
                  searchText: true,
                  perform: () {
                    ref.refresh(unavailableRoomProvider);
                  },
                ),
              ),
            ),
